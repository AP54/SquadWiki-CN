...
当前发布版本：[v5.1](./update/v5.0/release-notes/)
...
- 2023-07-27：更新地图手册5.1（部分）；

- 2023-06-30：更新5.0地图手册；

- 2023-06-23：更新5.0载具生成命令；

- 2023-06-13：阵营派系内容完结；

- 2023-05-28：阵营派系装备汉化；[部署物生成命令](/server/command/deployable)更新至 v4.5；[载具部署指令](/server/command/vehicle)更新至 v4.5，并调整了顺序和增加分类；

- 2023-05-25：阵营派系标题汉化；同步 v4.5 更新日志（[中文](/update/v4.5/release-notes/) [英文](/update/v4.5/release-notes/en)）；
