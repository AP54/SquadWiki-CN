...
- vehicle_repair 
    ...
    `AdminCreateDeployable /Game/Gameplay/Deployables/BP_vehicle_repair.BP_vehicle_repair_C`
...
- TestLadder_Metal 
    ...
    `AdminCreateDeployable /Game/Gameplay/Deployables/BP_TestLadder_Metal.BP_TestLadder_Metal_C`
